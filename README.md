...
1. The block settings panel in the Gutenberg sidebar, showing visibility toggles for titles, captions, and download actions.
2. A frontend preview of a completed grid layout displaying multiple styled PDF blocks with cohesive download buttons. Uses the core grid block for the layout and shows titles and download buttons.
3. A frontend preview of a single PDF Thumbnail Link block with caption and download button.
